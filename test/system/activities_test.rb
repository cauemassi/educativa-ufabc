...
class ActivitiesTest < ApplicationSystemTestCase
  ...
  test "should create activity" do
    ...
    fill_in "Difficulty", with: @activity.difficulty
    check "Is public" if @activity.is_public
    fill_in "Question quantity", with: @activity.question_quantity
    fill_in "Theme", with: @activity.theme
